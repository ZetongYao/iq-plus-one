...
export default function Home() {
  return (
    <>
      ...
      {/* Features */}
      <section className="border-t border-slate-200/60 px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200/60 bg-white p-8 shadow-sm transition hover:shadow-md">
      ...
      <section className="border-t border-slate-200/60 px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-14 grid gap-10 sm:grid-cols-3 sm:gap-8">
            <div>
              <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-full bg-slate-900 text-sm font-bold text-white">
                1
              </div>
              <h3 className="mt-5 text-base font-semibold text-slate-900">
                Pay $1
        ...
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200/60 bg-white p-8 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">Blessings granted</p>
            </div>
